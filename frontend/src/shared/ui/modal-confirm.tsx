...
export const ModalConfirm = ({ confirmAction, modalText }: ModalPropType) => {
  return (
    <div className="fixed inset-0 z-50 backdrop-blur-[8px] flex flex-col animate-blure transition-all">
      <section className="m-auto w-[60%] md:w-80 border-2 border-gray-400 rounded-lg p-4 bg-[rgba(255,255,255,1)] animate-appearing transition-all">
